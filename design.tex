...
\textbf{TODO} Preco som si vybral zrovna tuto metodu (prirodzena, rozumna, dobre skalovatelna)
...
\textbf{TODO} zhrnutie navrhu - treba vyzdvihnut cim je unikatna metoda. (Personalizovany newsletter pre CQA,
zameranie na div a akt, odporucanie otazok v CQA (nie routing), expertiza aj interest, komunitny profil).
