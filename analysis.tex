...
\textbf{TODO}
Viac analyzovat SO newsletter, ABC casti, popisat - ako su robene tie sekcie
Plus nazory ludi z Meta SO
formulovat to ako motivaciu, ze ludia to chcu, ake problemy videli atd.
...
\begin{myitemize}
  \myitem{\textbf{1. Kontrolná vzorka} -- Týmto používateľom neboli ponúknuté žiadne odporúčania.}
  \myitem{\textbf{2. Odporúčanie na základe relevancie} -- Používateľom boli ponúknuté odporúčania iba na základe relevancie
        daných otázok, bez ohľadu na aktuálnosť alebo diverzitu.}
  \myitem{\textbf{3. Odporúčanie s ohľadom na aktuálnosť} -- Používateľom boli odporúčané relevantné otázky, pričom 50\% z nich
        pochádzalo z posledných štyroch hodín a 20\% bolo vybraných prostredníctvom tématického výberu vzoriek.}
  \myitem{\textbf{4. Diverzifikované odporúčanie} -- Používateľom boli odporúčané relevantné otázky, pričom 50\% z nich
